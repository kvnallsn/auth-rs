...
impl FidoU2fAttestation {
    ...
    pub fn validate(
        &self,
        mut auth_data: AttestationAuthData,
        ...
        let mut raw_key = match auth_data.key.alg {
            CoseKeyAlgorithm::ES256(params) => match params.as_x962_raw() {
                Some(r) => r,
        ...
        verification_data.append(&mut auth_data.cred_id);
        verification_data.append(&mut raw_key);
